                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <NavLink className="nav-link" area-current="page" to="/home">Home</NavLink>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <ProductConsumer>
                                        {(value) => {
                                            return (<NavLink className="nav-link" to="/cart"><span class="fa fa-cart-arrow-down"></span> Cart ({value.Cart.length}) </NavLink>)
                                        }}

                                    </ProductConsumer>
                                </li>
                                <li className="nav-item">
                                    <NavLink className="nav-link" to="/login"> <span class="fa fa-user-circle"></span>Login</NavLink>
                                </li>
                                <li className="nav-item">
                                ...
                                <li className="nav-item">
                                    <NavLink className="nav-link" to="/search"><i class='fa fa-search'></i>Search
